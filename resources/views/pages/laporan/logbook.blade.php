    ...
    <div class="page-header">
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col">
                    <div class="page-header-title"><h5>Rekap Logbook</h5></div>
                </div>
                <div class="col-auto">
                    <ul class="breadcrumb">
                    ...
                    <tbody>
                        @forelse($logbooks as $lb)
                            <tr>
                                ...
                                <td style="max-width:300px;">{{ Str::limit($lb->deskripsi_kegiatan, 100) }}</td>
                                <td>
                                    @if($lb->file_bukti)
                                        <a href="{{ asset('storage/' . $lb->file_bukti) }}" target="_blank" style="font-size:12px;"><i class="ti ti-paperclip"></i></a>
                                    @elseif($lb->link_bukti)
                                        <a href="{{ $lb->link_bukti }}" target="_blank" style="font-size:12px;"><i class="ti ti-link"></i></a>
                                    @else
                                        —
                                    @endif
                                </td>
