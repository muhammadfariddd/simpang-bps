    ...
    <div class="page-header">
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col">
                    <div class="page-header-title"><h5>Detail Logbook</h5></div>
                </div>
                <div class="col-auto">
                    <ul class="breadcrumb">
                ...
                <div class="card-body">
                    <table style="width:100%;font-size:14px;border-collapse:separate;border-spacing:0 6px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="background:#f8f9fa;padding:12px;border-radius:8px;line-height:1.6;">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ asset('storage/' . $logbook->file_bukti) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="background:{{ $logbook->status === 'revisi' ? '#fff3cd' : '#d1e7dd' }};padding:10px;border-radius:8px;">
                                    <i class="ti ti-message"></i> {{ $logbook->komentar_admin }}
                                    <br><small style="color:#8996a4;">— {{ $logbook->validator?->nama_lengkap }} pada {{ $logbook->divalidasi_pada?->format('d M Y H:i') }}</small>
                                </div>
                            </td>
                        </tr>
                        @endif
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('logbook.validasi', $logbook->id) }}">
                        ...
                        <div style="display:flex;gap:8px;">
                            <button type="submit" name="aksi" value="disetujui" class="btn btn-success" style="flex:1;">
                                <i class="ti ti-check"></i> Setujui
                            </button>
                            <button type="submit" name="aksi" value="revisi" class="btn btn-warning" style="flex:1;">
